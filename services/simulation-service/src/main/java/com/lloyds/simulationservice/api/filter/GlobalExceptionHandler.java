package com.lloyds.simulationservice.api.filter;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleTimeout(SimulationTimeoutException ex) {
        log.warn("Simulation timeout: {}", ex.getMessage());
        var problem = ProblemDetail.forStatusAndDetail(HttpStatus.GATEWAY_TIMEOUT, ex.getMessage());
        problem.setType(URI.create("https://api.lloyds.com/errors/simulation-timeout"));
        problem.setTitle("Simulation Timeout");
        enrich(problem);
        return problem;
    }
